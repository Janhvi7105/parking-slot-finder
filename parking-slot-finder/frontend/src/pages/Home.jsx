...
export default function Home() {
  return (
    ...
    >
      ...
      <div className="relative h-full flex flex-col backdrop-blur-[2px]">
        
        {/* Navbar with glass morphism effect */}
        <div className="flex justify-between items-center px-6 md:px-12 lg:px-20 py-5 md:py-6">
          ...
          <div className="flex items-center gap-3 group cursor-pointer">
            ...
            <h2 className="text-white text-xl md:text-2xl font-black tracking-wider drop-shadow-lg bg-gradient-to-r from-white to-gray-300 bg-clip-text text-transparent">
              PARKING SLOT FINDER
            </h2>
          </div>
          ...
          <div className="flex gap-3 md:gap-4">
            ...
            <Link
              to="/user-login"
              className="group relative overflow-hidden bg-gradient-to-r from-blue-600 to-blue-500 px-5 py-2.5 rounded-xl font-semibold text-white shadow-lg hover:shadow-blue-500/30 transition-all duration-300 hover:scale-105"
            >
            ...
            <Link
              to="/admin-login"
              className="group relative overflow-hidden bg-gradient-to-r from-purple-600 to-purple-500 px-5 py-2.5 rounded-xl font-semibold text-white shadow-lg hover:shadow-purple-500/30 transition-all duration-300 hover:scale-105"
            >
              <span className="relative z-10 flex items-center gap-2">
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <Link
              to="/register"
              className="group relative overflow-hidden bg-gradient-to-r from-green-600 to-emerald-500 px-5 py-2.5 rounded-xl font-semibold text-white shadow-lg hover:shadow-green-500/30 transition-all duration-300 hover:scale-105"
            >
              <span className="relative z-10 flex items-center gap-2">
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="flex-1 flex items-center justify-center px-4">
          <div className="text-center animate-fadeInUp">
            ...
            <div className="relative">
              ...
              <h1 className="relative text-white text-4xl md:text-6xl lg:text-7xl font-black tracking-tighter leading-tight mb-6">
            ...
            <div className="max-w-2xl mx-auto">
              <div className="backdrop-blur-md bg-black/30 rounded-2xl p-6 border border-white/20 shadow-2xl">
            ...
            <div className="mt-8 flex justify-center gap-6 text-white/60 text-xs">
